...
public class UniqueAPI {
    ...
    private UniqueAPI(RPManagerDirector director) {
        this.uniqueItemKey = new NamespacedKey(director.getPlugin(), "unique");
    }

    public static UniqueAPI getInstance(RPManagerDirector director) {
        if (instance == null) {
            if (director == null)
                throw new NullPointerException("injected dependency is null");
            UniqueAPI.instance = new UniqueAPI(director);
        }
        return instance;
    }
